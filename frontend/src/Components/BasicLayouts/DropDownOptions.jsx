...
const DropDownOptions = (props) => {
    ...
    return (
        <div id="dropdown" className={` ${setHidden?"hidden":""} bg-white divide-y divide-white-100 rounded-lg shadow-lg border-2 w-44  z-[1000]`}>
            <ul className=" text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                <li>
                    <a href="#" className="block px-4 py-2 text-black hover:bg-gray-100 ">Profile</a>
                </li>
                <li>
